...
Subject to the terms and conditions of this Agreement, we grant you a limited, non-exclusive, non-transferable, non-sublicensable, revocable license to download, install, and use the App on a mobile device that you own or control, solely for your personal, non-commercial use.
...
The App is provided free of charge. No payment is required to download, install, or use the App. This license does not constitute a sale of the App or any copy thereof.
...
You retain ownership of content you create and upload through the App (including item listings, photos, messages, and board posts). By using the App, you grant us a non-exclusive, worldwide, royalty-free license to use, display, store, process, and distribute your content solely for the purpose of operating and providing the App, as further described in our Terms of Use.

### 3.4 Feedback

Any feedback, suggestions, or ideas you provide regarding the App may be used by us without any obligation to you. You assign to us all rights in any such feedback.

---

## 4. Data Collection and Privacy

Your use of the App is subject to our [Privacy Policy](PRIVACY_POLICY.md), which describes how we collect, use, store, and protect your personal information. By using the App, you consent to our data practices as described in the Privacy Policy. Key points include:

- We collect account information (email, username), item listing data, messages, ratings, and device tokens
- Photos are processed (resized, compressed, converted to WebP) and stored on Cloudflare R2
- Passwords are hashed with bcrypt and never stored in plain text
- We use third-party services for email delivery (Resend), image storage (Cloudflare R2), and push notifications (Expo)
...
The App relies on third-party services to function. Your use of the App is also subject to the terms and conditions of these third-party providers:

- **Cloudflare R2** for photo storage
- **Resend** for email delivery
- **Expo** for push notifications
- **Platform app stores** (Apple App Store, Google Play) for distribution

We are not responsible for the practices, availability, or performance of any third-party services.
...
We may from time to time issue updates, patches, or new versions of the App. You agree that we may automatically update the App on your device. Updated versions of the App are subject to this Agreement unless a revised Agreement is provided, in which case the revised Agreement will govern.

### 6.2 Changes to This Agreement

We reserve the right to modify this Agreement at any time. Material changes will be communicated through the App or via email. Your continued use of the App after changes are posted constitutes acceptance of the modified Agreement.
...
- **NON-INFRINGEMENT**
- **THAT THE APP WILL BE UNINTERRUPTED, ERROR-FREE, SECURE, OR VIRUS-FREE**
...
- The continued availability or operation of the App
- The accuracy, reliability, or completeness of any content
- The quality, safety, or legality of items listed by users
- The identity, trustworthiness, or conduct of any user
- The security of data transmitted through the App
- The accuracy of community moderation decisions
...
- Any content you post or transmit through the App
...
**BY DOWNLOADING, INSTALLING, AND USING THE APP, YOU EXPRESSLY ACKNOWLEDGE AND ASSUME ALL RISKS ASSOCIATED WITH:**

- Using a free, community-operated platform with no guarantees
- Interacting with other users, including meeting in person to exchange items
- Receiving items that may be defective, unsafe, misdescribed, or otherwise unsuitable
- Possible data loss due to service interruption or technical failure
...
You agree to comply with all applicable export and re-export control laws and regulations in your use of the App.
